...
function parse_config(config)
{
    ...
    console.log(`after parse config,praise_switch:${praise_switch}， keyword:${keyword}`)
}
...
function get_comment() {
    comment_list = {
        ...
        "搞笑视频": [
            ...
            "hahahahaha",
            "忍住了",
            "今年的赞快点完了，明天见各位[doge][doge]",
            "听说这里的up每条评论都点赞，所以我就来了[doge][doge][doge]",
            "离谱 好久不见[脱单doge]",
            "我特么在厕所抖得像个神经病……",
            "UP猪要是赞我我就女装，穿啥你们自己选[吃瓜][吃瓜][吃瓜]，关注我吧~",
            "三联暗示→_→",
            "有内鬼 终止交易",
            "大家快去看我动态！！！",
            "赌两个硬币这视频三天内破10万",
            "已三连。我有最新投稿，看我动态，欢迎白嫖[吃瓜][吃瓜][吃瓜]",
            "(=・ω・=)",
            "真是个骚气的视频",
            "三联了,求关",
            "333333333333",
            ...
            "爷青回",
            "每日一遍",
            "已三连。可以的话帮我写个弹幕[脱单doge][脱单doge][脱单doge][脱单doge]"
        ]
    }

    let comments = comment_list['我的世界']
    if (comment_list.hasOwnProperty(keyword))
        comments = comment_list[keyword]
